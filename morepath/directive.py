...
class SimpleRegistry(object):
    def __init__(self):
        self._dump_json = singledispatch(lambda obj, request: obj)
    ...
    def dump_json(self, request, obj):
...
class DumpJsonAction(dectate.Action):
    ...
    def perform(self, obj, proxy):
        proxy._dump_json.register(self.model)(obj)
