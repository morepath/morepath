...
class App(dectate.App):
    ...
    def do_load_json(self, json, request):
        ...
        """
        return generic.load_json(json, request, lookup=self.lookup)
    ...
    def do_dump_json(self, obj, request):
        ...
        """
        return generic.dump_json(obj, request, lookup=self.lookup)
    ...
    def _get_link_prefix(self, request):
        ...
        """
        return generic.link_prefix(request, lookup=self.lookup)
